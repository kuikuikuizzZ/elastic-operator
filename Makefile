...
ROOT := github.com/pytorch/elastic/kubernetes

# Target binaries. You can build multiple binaries for a single project.
TARGETS := elastic-controller
...
# REGISTRY ?= 10-20-101-1.caicloudprivatetest.com/release
...
update: push
	imageName=$(IMAGE_PREFIX)elasticjob-controller$(IMAGE_SUFFIX);                       \
	image=$(REGISTRY)/$${imageName}:$(VERSION);                                        \
	kubectl -n kube-system patch deploy mlneuron-controller-controller-v1-0 -p         \
